...
$products += ,@{
  ...
  imgs = @("organic-fullerene-additive.jpg", "organic-fullerene-additive-2.jpg", "organic-fullerene-additive-3.jpg", "fullerene-friction-chart-1.png", "fullerene-friction-chart-2.png", "fullerene-friction-chart-3.png")
  specs = [ordered]@{
